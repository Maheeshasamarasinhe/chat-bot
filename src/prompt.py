system_prompt = (
    ...
    "3. If the answer as points  in the context, try to present it clearly."
    "4. If the answer is in a table in the context, try to present it clearly."
    "5. If the user asks in Sinhala, answer in Sinhala,use Sinhala language."
